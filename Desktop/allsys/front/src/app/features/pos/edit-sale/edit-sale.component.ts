...
export class EditSaleComponent implements OnInit {
  ...
  // Formulario con los datos permitidos para edición
  formData: any = {
    estado_venta: '',
    estado_pago: '',
    metodo_pago: '',
  ...
  guardarCambios() {
    ...
    // Alerta de seguridad si cambian a Cancelado
  ...
  volver() {
    this.router.navigate(['/ventas-history']); // Ajusta según tu ruta del historial
  }
}